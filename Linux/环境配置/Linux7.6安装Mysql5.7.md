# Linux(CentOS-7.6)安装Mysql-5.7.38

## 1.下载

点击 ☞ [Mysql官网](https://downloads.mysql.com/archives/community/) 选择需要下载的版本进行下载

![下载说明](/Users/dream/学习文档/个人笔记/assets/linux/configuration/mysql_download.jpg)
